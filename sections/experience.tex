...
% \section{EXPERIENCE}
  \customSubHeadingContentStart
    ...
    \customSubHeading
    {Associate Manager, Data Analytics \& Engineering}{Mar YYYY – Present}
    \customRoleHeading
    ...
    \customSubHeading
    {Business Intelligence Analyst}{Dec YYYY – Mar YYYY}
    \customRoleHeading
    {\href{https://www.example.com/}{\textbf{Organization Name}}}{ City, Country}
    \vspace{-15pt}
      \customItemListStart
    ...
    \customSubHeading
    {Senior Software Engineer}{Oct YYYY – Dec YYYY}
    \customRoleHeading
    {\href{https://www.example.com/}{\textbf{Organization Name}}}{ City, Country}
    \vspace{-15pt}
    \customItemListStart
  
        \customItem{\textbf{Led end-to-end development} of \textit{\href{http://www.example.com}{\textbf{Example ERP}}} for large-scale warehouse, inventory, audit, and supply-chain operations across Indian fertilizer firms, managing cross-functional teams and aligning with client workflows.}
    ...
    \customSubHeading
    {Software Engineer}{May YYYY – Sep YYYY}
    \customRoleHeading
    {\href{https://www.example.com/}{\textbf{Organization Name}}}{ City, Country}
    \vspace{-15pt}
      \customItemListStart
